...
>
  ...
  <div className="relative max-w-7xl mx-auto px-6 py-20">
    ...
    <div className="mt-6 flex gap-3">
      ...
      {/* Brand */}
      <div>
        <h3 className="text-xl font-bold text-gray-900">RentEasy</h3>
        <p className="mt-3 text-sm text-gray-600">
          Discover verified rental properties from trusted owners.
          Simple. Secure. Fast.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-gray-600">
          <li className="hover:text-orange-500 cursor-pointer">All Properties</li>
          <li className="hover:text-orange-500 cursor-pointer">Featured Homes</li>
          <li className="hover:text-orange-500 cursor-pointer">Top Cities</li>
        </ul>
      </div>
      ...
      {/* CTA */}
      <div>
        <h4 className="font-semibold text-gray-900 mb-3">Become an Owner</h4>
        <p className="text-sm text-gray-600 mb-4">
          List your property and reach thousands of tenants.
        </p>
